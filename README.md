...
De MAPK signaling pathway staat bovenaan de [dotplot](figuren/dotplotGO.png). MAPK staat voor Mitogen-activated protein kinase, en het is een belangrijk onderdeel van de kinase cascade [(Morrison, 2012)](Bronnen/MAP_Kinase_Pathways.pdf). Kinases zijn belangrijk voor de levenscyclus van de cel, als MAPK geactiveerd wordt draagt het bij aan ontstekingsreacties en celgroei. Het remmen van MAPK kan wel werken tegen reuma, maar er is nog altijd meer onderzoek nodig voor een goed medicijn [(Xie et al., 2025)](Bronnen/MAPK_ERK_signaling_pathway_in_rheumatoid_arthritis_mechanisms_and_therapeutic_potential.pdf). De NOD-like receptor signaling pathway staat hoog op de [dotplot](figuren/dotplotGO.png) en het is erg significant. NOD-like receptors zijn PPR’s (pattern recognition receptors), ze kunnen immuun responses activeren doormiddel van inflammasomes en de activatie van NF-kappa B, IRF en MAPK pathways. [(Zhong et al., 2013)](Bronnen/Functions_of_NOD_Like_Receptors_in_Human_Diseases.pdf) De NOD-like receptors kunnen het begin zijn van een ontsteking bij reuma [(McCormack et al., 2009)](Bronnen/Toll_like_receptors_and_NOD_like_receptors_in_rheumatic_diseases.pdf).

In de [pathway](figuren/hsa04621.pathview.png) van de NOD-like receptors is te zien dat NF-kappa B en MAPK samen met de receptors werken om pro-inflammatory cytokines te maken, en dat deze actiever zijn dan normaal. Dit was ook al gevonden in het onderzoek van [Zhong et al. (2013)](Bronnen/Functions_of_NOD_Like_Receptors_in_Human_Diseases.pdf). Ook lijken de Pro-inflammatory effects hoger te zijn. NF-kappa B is belangrijk voor het immuunsysteem om pro inflammatory cytokines te maken na de activatie van een PRR [(Pires et al., 2018)](Bronnen/NF_kappaB_Two_Sides_of_the_Same_Coin.pdf), dit is ook terug te zien in de [pathway](figuren/hsa04621.pathview.png). 

In het kort, het lijkt erop dat de NOD-like receptors een belangrijke rol spelen bij patiënten met reuma. MAPK en NF-kappa B zijn betrokken bij de ontstekingen die gestart zijn door de receptoren, en ook het gen SRGN helpt mee om ontstekingen voort te zetten.
