...
## Conclusie
In de [vulcanoplot](figuren/VolcanoplotWC.png) zijn 3 merkwaardige genen gevonden, ANKRD30BL staat het hoogst in de figuur wat betekent dat dit het meest significante gen is. Dit gen is niet veel over bekent de exacte functie hiervan helaas ook niet. Wel is bekent dat ANKRD30BL iets te maken heeft met Kallmann syndroom, het is niet direct verbonden aan reuma [(ANKRD30BL Gene - GeneCards | A30BL Protein | A30BL Antibody, n.d.)](Bronnen/ANKRD30BL_gene.url). MT-ND6 is een ander merkwaardig gen uit de [volcanoplot](figuren/VolcanoplotWC.png), dit gen is uit mitochondriaal DNA. Het codeert voor NADH dehydrogenase 6 wat onderdeel is van complex I. Ook MT-ND6 lijkt geen directe verbinding te hebben met reuma [(MT-ND6 Gene: MedlinePlus Genetics, n.d.)](Bronnen/MT_ND6_Gene). Het laatste merkwaardige gen is het meest significante gen waarvan meer aanwezig is dan normaal, SRGN. Dit gen lijkt wel een connectie te hebben met reuma. SRGN codeert namelijk voor het eiwit serglycin wat een rol speelt in ontstekingen [(Korpetinou et al., 2014)](Bronnen/Serglycin_At_the_Crossroad_of_Inflammation_and_Malignancy.url). In een onderzoek van [Tyagi et al. (2023)](Bronnen/Deciphering_novel_common_gene_signatures_for_rheumatoid_arthritis_and_systemic_lupus_erythematosus_by_integrative_analysis_of_transcriptomic_profiles.url) over genen die te maken hebben met reuma is SRGN er als een van de genen die belangrijk zijn uitgekomen. 
